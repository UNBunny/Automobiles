...
<head>
    ...
    <?php if (!empty($_ENV['YANDEX_METRIKA_ID'])): ?>
    ...
    <script type="text/javascript" >
       ...
       ym(<?php echo $_ENV['YANDEX_METRIKA_ID']; ?>, "init", {
            clickmap:true,
            trackLinks:true,
    ...
    <noscript><div><img src="https://mc.yandex.ru/watch/<?php echo $_ENV['YANDEX_METRIKA_ID']; ?>" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
    <!-- /Yandex.Metrika counter -->
    <?php endif; ?>
</head>
<body>
